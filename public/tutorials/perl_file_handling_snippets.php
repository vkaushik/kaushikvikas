...
============================-->
<?php include './perl_file_handling_snippets_content.html'; ?><!-- End of Post -->


<!-- Update Previous and Next links here
========================================= -->
<nav><ul class="pager">
<li><a href="./perl_basics_snippets.php">Previous</a></li>
<li><a href="./perl_strings_snippets.php">Next</a></li>
</ul></nav>
